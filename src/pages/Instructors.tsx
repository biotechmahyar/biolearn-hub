      ...
      <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6">
        <div className="max-w-2xl">
          ...
          <p className="mt-3 text-sm leading-6 text-muted-foreground sm:text-[15px]">
            تیم اصلی زیست‌آکادمی چهار دانشجوی میکروبیولوژی و یک دانشجوی
            بیوتکنولوژی است؛ استادان مهمان متخصص هم کارگاه‌ها و دوره‌های تخصصی را
            برگزار می‌کنند. برند متعلق به پلتفرم است، نه به یک فرد خاص.
          </p>
        </div>
