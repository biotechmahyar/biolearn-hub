          ...
          <CardContent className="p-4">
            <div className="flex flex-wrap items-center justify-between gap-3">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-sm font-bold">رزومه دیجیتال و صفحه عمومی اختصاصی</p>
                  <p className="text-xs text-muted-foreground mt-0.5">
                    رزومه خود را بسازید و با یک لینک اختصاصی دوره‌ها، مهارت‌ها و گواهی‌هایتان را به اشتراک بگذارید.
                  </p>
                </div>
              </div>
              <div className="flex gap-2">
                <Button asChild size="sm">
                  <Link to="/resume">
                    <FileText className="ml-1.5 w-4 h-4" />
                    رزومه من
                  </Link>
                </Button>
                <Button asChild size="sm" variant="outline">
                  <Link to="/skills">
                    <Globe className="ml-1.5 w-4 h-4" />
                    مهارت‌ها
                  </Link>
                </Button>
              </div>
