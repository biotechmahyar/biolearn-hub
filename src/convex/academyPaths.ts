...
export const adminMovePathItem = mutation({
  ...
  handler: async (ctx, args) => {
    ...
    if (idx < 0) throw new Error("آیتم یافت نشد.");
...
// ── Workshop list for adding to path ─────────────────────────────────────────
export const listAvailableWorkshops = query({
...
// ── Admin: Delete any suggestion (including approved) ───────────────────────
